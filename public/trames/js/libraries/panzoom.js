    ...
    ***************************************************************************** */
    ...
    function Panzoom(elem, options) {
        ...
        function constrainXY(toX, toY, toScale, panOptions) {
            ...
            // constraint image
            const left = -realWidth/2;
            const bottom = -realHeight/2;
            const right = dims.parent.width-realWidth/2;
            const up = dims.parent.height-realHeight/2;
            result.x = Math.min(Math.max(result.x, left), right);
            result.y = Math.min(Math.max(result.y, bottom), up);
